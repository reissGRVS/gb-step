...
template <std::uint8_t First, std::uint8_t Last>
struct static_for
{
...
static constexpr void switch0()
{
	...
	{
		case A: total+=num; break;
		case B: total+=num; break;
		case C: total+=num; break;
		case D: total+=num; break;
		case E: total+=num; break;
		case F: total+=num; break;
		case G: total+=num; break;
		case H: total+=num; break;
		case I: total+=num; break;
		case J: total+=num; break;
		case K: total+=num;  break;
		case L: total+=num;  break;
		case M: total+=num;  break;
		case N: total+=num;  break;
		case O: total+=num;  break;
		case P: total+=num;  break;
	}
}


void switch16(std::uint8_t num)
{
	switch (static_cast<ABC>(num))
	{
		case A: total+=num; break;
...
int main()
{
    ...
    std::mt19937 rng(dev());
    std::uniform_int_distribution<std::uint8_t> dist16(0,15);
	int loop;
