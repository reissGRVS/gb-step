...
private:
	...
	auto ArmOperation(OpCode opcode);
	//ARM Operations
	...
	const ParamSegments HalfwordDTRegOffsetSegments
		...
		= {{24, 24}, {23, 23}, {21, 21}, {20, 20}, {19, 16}, {15, 12}, {6, 6}, {5, 5}, {3, 0}};
